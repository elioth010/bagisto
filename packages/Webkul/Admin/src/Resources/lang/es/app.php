...
return [
    ...
    'required' => 'Requirido',
    'unique' => 'Unico',
    'locale-based' => 'Lenguaje principal',
    'channel-based' => 'Canal principal',
    'status' => 'Estado',
    'select-option' => 'Seleccione una opcion',
    'category' => 'Categoria',

    'common' => [
        'no-result-found' => 'No encontramos ningun resultado.',
        'country' => 'Pais',
        'state' => 'Estado',
        'true' => 'Verdadero',
        'false' => 'Falso'
    ...
    'layouts' => [
        ...
        'attribute-families' => 'Atributos de Familia',
        'customers' => 'Compradores',
        'groups' => 'Grupos',
        'reviews' => 'Reseña',
        'newsletter-subscriptions' => 'Boletin de Suscripcion',
        'configure' => 'Configuracion',
        'settings' => 'Ajustes',
        'locales' => 'Idiomas',
        'currencies' => 'Moneda',
        'exchange-rates' => 'Tipos de cambio',
        'inventory-sources' => 'Inventario',
        'channels' => 'Canales',
        'users' => 'Usuario',
        'roles' => 'Roles',
        'sliders' => 'Sliders',
        'taxes' => 'Impuestos',
        'tax-categories' => 'Categoria de impuestos',
    ...
    'acl' => [
        ...
        'taxes' => 'Impuestos',
        'tax-categories' => 'Categoria de impuestos',
        'tax-rates' => 'Tasa de cambio',
        'edit' => 'Editar',
        'create' => 'Agregar',
        'delete' => 'Borrar',
        'promotions' => 'Promociones',
        'cart-rules' => 'Reglas de Carrito',
        'catalog-rules' => 'Reglas de catalogo',
    ],
    ...
    'dashboard' => [
        ...
        'from' => 'De',
        'to' => 'Par',
        'total-customers' => 'Total de Compradores',
        'total-orders' => 'Total de Ordenes',
        'total-sale' => 'Total de Ventas',
        'average-sale' => 'Promedio de Orden Vendida',
        'increased' => ':progress%',
        'decreased' => ':progress%',
        'sales' => 'Ventas',
        'top-performing-categories' => 'Top de Categorias',
        'product-count' => ':count Productos',
        'top-selling-products' => 'Top de productos',
        'sale-count' => ':count Ventas',
        'customer-with-most-sales' => 'Compradores con mas ventas',
        'order-count' => ':count Ordenes',
        'revenue' => 'Ingresos :total',
        'stock-threshold' => 'Minimo de Stock',
        'qty-left' => ':qty Restante'
    ],

    'datagrid' => [
        'mass-ops' => [
            'method-error' => 'Error! Metodo incorrecto detectado, por favor revise la configuracion de accciones masivas',
            'delete-success' => 'Item seleccionado :resource fue borrado correctamete',
            'partial-action' => 'Algunas acciones no se realizaron debido a restricciones del sistema en :resource',
            'update-success' => 'Item seleccionado :resource fue actualizado satisfactoriamente',
            'no-resource' => 'El recurso proporcionado es insuficiente para la accion'
        ],
        ...
        'required' => 'Requerido',
        'unique' => 'Unico',
        'per-locale' => 'Lenguaje Principal',
        'per-channel' => 'Canal Principal',
        'position' => 'Posicion',
        'locale' => 'Idioma',
        ...
        'role' => 'Rol',
        'sub-total' => 'Sub Total',
        'no-of-products' => 'Num de productos',
        'attribute-family' => 'Atributo de Familia',
        'starts-from' => 'Comienza desde',
        'ends-till' => 'Termina hasta',
        'per-cust' => 'Por Clietne',
        'usage-throttle' => 'Veces usado',
        'for-guest' => 'Para Invitado',
    ...
    'users' => [
        'forget-password' => [
            ...
            'email' => 'Registar Correo Electronico',
            'password' => 'Contraseña',
            'confirm-password' => 'Confirmar Contraseña',
            'back-link-title' => 'Volver a Iniciar Sesion',
            'submit-btn-title' => 'Enviar Contraseña al correo'
        ],
        ...
        'roles' => [
            'title' => 'Roles',
            'add-role-title' => 'Agregar Role',
            'edit-role-title' => 'Editar Role',
            'save-btn-title' => 'Guardar Role',
            'general' => 'General',
            'name' => 'Nombre',
