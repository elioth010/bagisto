...
namespace Webkul\Takul\Http\Controllers\Admin;
...
class ConfigurationController extends Controller
{
     ...
     *
     * @param  \Webkul\Takul\Repositories\MetadataRepository  $velocityMetaDataRepository
     * @return void
     */
    public function __construct (VelocityMetadataRepository $velocityMetadataRepository)
    {
        ...
        $this->velocityHelper = app('Webkul\Takul\Helpers\Helper');
